...
// Represents an income account with description, amount, date, category
public class IncomeAccount implements Writable {
    ...
    public IncomeAccount(String description, double amount, String date, String category) {
